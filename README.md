# busqandote-scraper serverless API
The busqandote-scraper project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=busqandote-scraper -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3.2 -DgroupId=com.busqandote -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd busqandote-scraper
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "BusqandoteScraperApi",
                    "OutputKey": "BusqandoteScraperApi",
